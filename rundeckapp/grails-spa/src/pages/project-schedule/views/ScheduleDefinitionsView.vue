...
<script>
    ...
    import {
        bulkDeleteSchedules, deleteSchedule,
    ...
    export default Vue.extend({
        ...
        async mounted() {
            ...
            this.eventBus.$on('SCHEDULE_ASSIGN_CLOSING', (payload) => {
                if(payload.result){
                    this.setMessage(this.$i18n.t("message.saved"))
                }
        ...
        methods: {
            ...
            async deleteSchedule(){
                var result = await deleteSchedule(this.scheduleToDelete)
                this.scheduleToDelete = {}
                this.updateSearchResults(this.pagination.offset)
                this.setMessage(this.$i18n.t("message.deleted"))
            },
