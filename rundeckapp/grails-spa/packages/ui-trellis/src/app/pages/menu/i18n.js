...
const translationStrings = {
  ...
  es_419: {
    message: {
      pageUsersSummary: 'Lista de usuarios de Rundeck.',
      ...
      domainUserFirstNameLabel: 'Nombre',
      domainUserLastNameLabel: 'Apellido',
      domainUserEmailLabel: 'Email',
      domainUserLabel: 'Usuario',
      pageUsersTokensLabel: 'N\u00BA Tokens',
      pageUsersTokensHelp: 'Puedes administrar los token en la página del Perfil de Usuario.',
