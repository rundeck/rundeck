...
export default defineComponent({
  ...
  computed: {
    shouldShow() {
      return (
        (this.showClean && (this.exportStatus || this.importStatus)) ||
    ...
    tooltip() {
      ...
      if (this.exportStatus) {
        text += this.$t(`scm.export.status.${this.exportStatus}.description`);
      }
      if (this.importStatus) {
        text += this.$t(`scm.import.status.${this.importStatus}.description`);
      }
      return text;
    },
    textOutput() {
