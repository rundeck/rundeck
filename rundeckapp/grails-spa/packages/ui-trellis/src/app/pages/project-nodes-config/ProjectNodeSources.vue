<template>
  <div class="content">
    <div id="layoutBody">
      <div class="title">
        <span class="text-h3">
          <i class="fas fa-sitemap"></i> Edit Nodes
        </span>
      </div>
          ...
          <div class="col-xs-12">
            <div class="card">
              <div class="card-content">
                <div class="vue-tabs">
                  <page-confirm :event-bus="rundeckContext.eventBus" class="pull-right"
                    ...
                    <span class="text-warning">
                      ...
                      <a href="#plugins" >
                        ...
                        {{$t("framework.service.NodeEnhancer.label.short.plural")}}
                      </a>
                    </span>
                      </div>
                    </template>
                      ...
                      <writeable-project-node-sources :event-bus="rundeckContext.eventBus" class="list-group" item-css="list-group-item">
                        <template v-slot:empty>
                          <div class="list-group-item">
                            <span class="text-info"><i class="glyphicon glyphicon-info-sign"></i> {{$t("no.modifiable.sources.found")}}</span>
                          </div>
                        </template>
