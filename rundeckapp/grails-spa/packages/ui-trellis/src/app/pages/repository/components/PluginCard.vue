    ...
    <div class="card w-full p-6">
      <div class="col-md-3" v-if="result.record != null">
        <div
          v-if="
            result.record != null &&
            result.record.images.thumbnail != null &&
            result.record.images.thumbnail.url
          "
        >
          <div
            :style="{
              backgroundImage: `url( ${result.record.images.thumbnail.url} )`,
            }"
      ...
      <div class="col-md-9">
        <div v-if="result.currentVersion">
          Version {{ result.currentVersion }}
        </div>
        <div class="text-4xl font-bold">
          {{ result.display || result.name }}
        </div>
        <div style="margin-top: 0.5em">{{ result.support }}</div>
        ...
        <div class="">
          <div class="flexible">
            ...
            <div v-if="result.author" style="margin-bottom: 1em">
  ...
  computed: {
    ...
    displayCard() {
      if (this.showWhichPlugins === null) {
        ...
        this.result.support === "Enterprise Exclusive" &&
        this.showWhichPlugins === true &&
        window._RDPRO_EDITION
      ) {
        return true;
      } else if (
        this.result.support === "Enterprise Exclusive" &&
        this.showWhichPlugins === false &&
        window._RDPRO_EDITION
      ) {
        return false;
      } else {
