const messages = {
  ...
  "settings.uiEarlyAccess.description": "We're improving the Job Authoring UI incrementally. Use the toggle below to enable early access to updated features. You'll automatically receive new updates as they're released.",
  "settings.uiEarlyAccess.enableLabel": "Enable Next UI",
  "settings.uiEarlyAccess.availableNow": "Available now:",
  "settings.uiEarlyAccess.feature1": '"Workflow" tab including NEW Conditional Orchestrator.',
