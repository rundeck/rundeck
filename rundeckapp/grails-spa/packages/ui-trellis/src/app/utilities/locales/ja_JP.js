const messages = {
  ...
  "gui.menu.Nodes": "ノード",
  "commandExec.jobName.blank.message": "ジョブ名を定義してください。",
  "disabled.execution.run": "実行が無効です。",
  "disabled.job.run": "実行が無効です。",
  "disabled.schedule.run": "実行が無効です。",
  "Workflow.label": "ワークフロー",
  "Workflow.stepErrorHandler.label.on.error": "エラー時:",
  ...
  "JobExec.nodeStep.false.label": "ワークフローステップ",
  "scheduledExecution.groupPath.description": "グループは/で階層にできる",
  Project: "プロジェクト",
  Execution: "実行",
  ...
  "form.option.defaultValue.label": "既定値",
  "form.option.values.label": "許可された値",
  "form.label.valuesType.list.label": "リスト",
  "form.option.valuesType.url.label": "リモートURL",
  "form.option.valuesUrl.description": "リモートJSONサービスのURL",
  "form.option.enforcedType.label": "制限",
  "form.option.enforcedType.none.label": "任意の値",
  "form.option.enforced.label": "許可された値のみ",
  "form.option.regex.label": "正規表現でマッチした値",
  "form.option.multivalued.label": "複数の値",
  ...
  "Option.property.description.description": "説明はMarkdownで表示されます。",
  "delete.this.job": "このジョブを削除する",
  "scheduledExecution.jobName.label": "ジョブ名",
  "choose.action.label": "選択 …",
  "scheduledExecution.property.description.label": "説明",
  "schedule.to.run.repeatedly": "スケジュール登録して定期的に実行する",
  ...
  "scheduledExecution.action.disable.execution.button.label": "実行を無効化",
  "job.actions": "ジョブのアクション",
  filters: "フィルタ",
  "all.nodes": "すべてのノード",
  "job.bulk.modify.confirm.panel.title": "ジョブの一括修正を確認",
  "job.bulk.panel.select.title": "一括編集するジョブを選択",
  ...
  "page.home.search.projects.input.placeholder": "プロジェクトの検索",
};
