...
export default defineComponent({
  ...
  props: {
    ...
    showTitle: { type: Boolean, required: false, default: undefined },
    showIcon: { type: Boolean, required: false, default: undefined },
    showDescription: { type: Boolean, required: false, default: undefined },
    modelValue: {
    ...
    contextAutocomplete: { type: Boolean, required: false, default: undefined },
    autocompleteCallback: {
      type: Function as PropType<(...args: any[]) => any>,
      required: false,
      default: undefined,
    },
    useRunnerSelector: { type: Boolean, required: false, default: undefined },
    eventBus: {
      type: Object as PropType<Record<string, any>>,
      required: false,
      default: undefined,
