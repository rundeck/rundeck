...
describe("JobPageStore", () => {
  ...
  describe("performBulkAction", () => {
    ...
    it("should throw error on failed bulk delete", async () => {
      ...
      await expect(store.performBulkAction("delete")).rejects.toThrow(
    ...
    it("should handle schedule enable/disable", async () => {
      ...
      expect(bulkScheduleEnableDisable).toHaveBeenCalledWith(
        "TestProject",
        ["job1"],
        true,
      );
    ...
    it("should handle execution enable/disable", async () => {
      ...
      expect(bulkExecutionEnableDisable).toHaveBeenCalledWith(
        "TestProject",
        ["job1"],
        true,
      );
    ...
    it("should throw error on failed schedule enable/disable", async () => {
      ...
      await expect(store.performBulkAction("enable_schedule")).rejects.toThrow(
    ...
    it("should throw error on failed execution enable/disable", async () => {
      ...
      await expect(store.performBulkAction("enable_execution")).rejects.toThrow(
        "Some jobs could not be updated",
      );
    });
  });
  ...
  describe("URL Generation", () => {
    ...
    it("should create correct project SCM action href", () => {
      ...
      expect(href).toBe(
        "http://localhost:4440/project/TestProject/scm/export/performAction?actionId=commit",
      );
    });
    ...
    it("should create correct job page path href", () => {
      ...
      expect(href).toBe(
        "http://localhost:4440/project/TestProject/jobs/test/path",
      );
    });
  });
