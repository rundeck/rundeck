...
const Drawer = {
    ...
    renderHeader(h, prefixCls) {
      ...
      return (
        <div class={headerClassName} style={headerStyle}>
          ...
          {closable ? this.renderCloseIcon(h, prefixCls) : null}
        </div>
      );
    },
    renderCloseIcon(h, prefixCls) {
      const { closable } = this;
      return (
        closable && (
  ...
  render(h) {
    ...
    return <VcDrawer {...vcDrawerProps}>{this.renderBody(h, prefixCls)}</VcDrawer>;
  },
};
