...
const ConfigProvider = {
  ...
  methods: {
    ...
    renderProvider(h, legacyLocale) {
      return (
        <LocaleProvider locale={this.locale || legacyLocale} ANT_MARK__={ANT_MARK}>
  ...
  render(h) {
    return (
      <LocaleReceiver
        scopedSlots={{ default: (_, __, legacyLocale) => this.renderProvider(h, legacyLocale) }}
      />
    );
  },
};
