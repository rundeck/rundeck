...
class DailyIntervalTaskTrigger implements TaskTrigger, QuartzSchedulerTaskTrigger {
    ...
    @PluginProperty(title = "Unit", description = "Time unit", validatorClass = CalendarIntervalTaskTrigger.IntervalUnitValidator, required = true)
    @SelectValues(values = [], dynamicValues = true)
    @DynamicSelectValues(generatorClass = CalendarIntervalTaskTrigger.IntervalUnitGenerator)
    String unit
