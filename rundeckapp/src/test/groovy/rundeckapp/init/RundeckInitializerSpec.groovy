...
class RundeckInitializerSpec extends Specification {
    ...
    @Unroll
    def "deobfuscateIfNeeded passes through #scenario unchanged"() {
        expect:
        RundeckInitializer.deobfuscateIfNeeded(input) == expected

        where:
        scenario                | input                                    | expected
        "null value"            | null                                     | null
        "plain text"            | "mysecretpassword"                       | "mysecretpassword"
        "MD5 prefixed value"    | "MD5:5f4dcc3b5aa765d61d8327deb882cf99"   | "MD5:5f4dcc3b5aa765d61d8327deb882cf99"
        "BCRYPT prefixed value" | 'BCRYPT:$2a$10$abcdef'                   | 'BCRYPT:$2a$10$abcdef'
        "empty string"          | ""                                       | ""
    }

    def "deobfuscateIfNeeded correctly deobfuscates OBF values"() {
        given:
        def cleartext = "mysecretpassword"
        def obfuscated = Password.obfuscate(cleartext)

        expect:
        obfuscated.startsWith("OBF:")
        RundeckInitializer.deobfuscateIfNeeded(obfuscated) == cleartext
    }

    def "deobfuscateIfNeeded works with known OBF value from Rundeck 5.x"() {
        expect: "OBF value for 'adminadmin' generated by Jetty Password utility"
        RundeckInitializer.deobfuscateIfNeeded("OBF:1u2a1toa1w8v1tok1u301u2a1toa1w8v1tok1u30") == "adminadmin"
    }
