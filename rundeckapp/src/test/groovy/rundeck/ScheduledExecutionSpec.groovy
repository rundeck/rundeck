...
class ScheduledExecutionSpec extends Specification implements DataTest
{
    ...
    void testGenerateJobScheduledName() {
        ...
        def props = [uuid:"00000",jobName: "TestName", project: "TestFrameworkProject", type: "AType", command: "doCommand", argString: "-test", description: "whatever"]
        se.properties = props
        se.validate()
        ...
        assertEquals "incorrect job name: ${se.generateJobScheduledName()}", se.uuid + ":TestName", se.generateJobScheduledName()
    }
