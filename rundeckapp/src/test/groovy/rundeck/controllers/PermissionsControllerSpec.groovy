...
class PermissionsControllerSpec extends Specification implements ControllerUnitTest<PermissionsController>  {
    ...
    def "verify permissions/application/{kind} successful response"() {
        given:
        ...
        when:
        controller.appContextPermissionsForResourceKind()
    ...
    def "verify permissions/application/{kind} throws MissingParameter when no `actions` supplied in query"() {
        given:
        final def kind = 'project'
    ...
    def "verify permissions/application/{type}/{specifier} successful response"() {
        given:
        ...
        when:
        controller.appContextPermissionsForTypeWithSpecifier()
    ...
    def "verify permissions/application/{type}/{specifier} throws InvalidParameterException when invalid `type` is supplied in path"() {
        given:
    ...
    def "verify permissions/projects/{project}/{kind} successful response"() {
        given:
        final def kind = 'job'
        final def authorizedAction = 'read'
        final def unAuthorizedAction = 'write'
        ...
        when:
        controller.projectContextPermissionsForResourceKind()
    ...
    def "verify permissions/project/{project}/job/{specifier} successful response"() {
        given:
        final def authorizedAction = 'read'
        final def unAuthorizedAction = 'write'
        ...
        when:
        controller.projectContextPermissionsForJob()
    ...
    def "verify permissions/project/{project}/job/{specifier} throws InvalidParameterException when job is non-existent"() {
        given:
        final def authorizedAction = 'read'
        final def unAuthorizedAction = 'write'
        final def jobId = 'job123'
    ...
    def "verify permissions/project/{project}/job/{specifier} throws InvalidParameterException when job does not belong to the project specified in path param"() {
        given:
        final def authorizedAction = 'read'
        final def unAuthorizedAction = 'write'
        final def jobId = 'job123'
