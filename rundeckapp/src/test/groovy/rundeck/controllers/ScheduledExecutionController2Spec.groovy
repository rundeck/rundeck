...
class ScheduledExecutionController2Spec extends Specification implements ControllerUnitTest<ScheduledExecutionController>, DataTest {
...
//        request.api_version = 5
    ...
    public void testApiRunCommand_JSON() {
        when:
        def sec = controller
