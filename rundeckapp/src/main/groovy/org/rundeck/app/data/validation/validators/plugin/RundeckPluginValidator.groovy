package org.rundeck.app.data.validation.validators.plugin
...
class RundeckPluginValidator implements Validator {
    ...
    RundeckPluginValidator(FrameworkService frameworkService, Class pluginType, String pluginTypeField, String pluginConfigField) {
