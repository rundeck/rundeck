...
import org.rundeck.app.data.util.WorkflowStepDataUtil

class WorkflowExecutionItemFactory {

    /**
     * Create an WorkflowExecutionItem instance for the given Workflow,
     * suitable for the ExecutionService layer
     */
   static WorkflowExecutionItem createExecutionItemForWorkflow(WorkflowData workflow) {
