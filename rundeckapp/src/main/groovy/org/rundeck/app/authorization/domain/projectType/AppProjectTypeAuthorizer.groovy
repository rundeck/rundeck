...
import org.rundeck.app.authorization.domain.appType.AppAuthorizingAppType
 ...
 */
@CompileStatic
class AppProjectTypeAuthorizer
    extends BaseResourceIdAuthorizer<Singleton, AuthorizingProjectType, ProjectTypeIdentifier> {
