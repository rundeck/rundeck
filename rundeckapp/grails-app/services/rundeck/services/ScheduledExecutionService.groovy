    ...
    Map loadOptionsRemoteValues(ScheduledExecution scheduledExecution, Map mapConfig, def username, AuthContext authContext) {
        ...
        do{
            try {
                ...
                remoteResult = ScheduledExecutionController.getRemoteJSON({ -> new SystemProxyHttpClient() }, srcUrl, configRemoteUrl, timeout, contimeout, retryCount, disableRemoteOptionJsonCheck)
