...
interface AuthorizingJobService {
    ...
    ExecutionReference startJob(UserAndRolesAuthContext auth, JobReference jobReference, String jobArgString, String jobFilter, String asUser)
        throws JobNotFound, JobExecutionError

    ExecutionReference startJob(UserAndRolesAuthContext auth, JobReference jobReference, Map optionData, String jobFilter, String asUser)
        throws JobNotFound, JobExecutionError
