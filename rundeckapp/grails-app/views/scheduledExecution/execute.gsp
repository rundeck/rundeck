<html>
  <head>
    ...
    <title><g:appTitle/> - <g:enc>${scheduledExecution?.jobName} : ${scheduledExecution?.description}</g:enc> : Execute <g:message code="domain.ScheduledExecution.title"/>  &hellip;</title>
