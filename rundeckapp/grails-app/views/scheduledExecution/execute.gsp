<html>
  <head>
    ...
    <title><g:message code="main.app.name"/> - <g:enc>${scheduledExecution?.jobName} : ${scheduledExecution?.description}</g:enc> : Execute <g:message code="domain.ScheduledExecution.title"/>  &hellip;</title>
