...
<g:render template="/scheduledExecution/editNotificationsTriggerForm"
          model="${[
                  ...
                  triggerEmailExternalFilePathName: ScheduledExecutionController.NOTIFY_FAILURE_EXTERNAL_FILE_PATH_NAME_ATTACH,
                  triggerEmailExternalFileAttachName: ScheduledExecutionController.NOTIFY_FAILURE_EXTERNAL_ATTACH,
...
<g:render template="/scheduledExecution/editNotificationsTriggerForm"
          model="${[
                  ...
                  triggerEmailExternalFilePathName: ScheduledExecutionController.NOTIFY_ONSTART_EXTERNAL_FILE_PATH_NAME_ATTACH,
                  triggerEmailExternalFileAttachName: ScheduledExecutionController.NOTIFY_ONSTART_EXTERNAL_ATTACH,
                  isEmail: isStart,
                  isUrl: isStartUrl,
                  defEmail: defStart,
                  defUrl: defStartUrl,
...
<g:render template="/scheduledExecution/editNotificationsTriggerForm"
          model="${[
                  ...
                  triggerEmailExternalFilePathName: ScheduledExecutionController.NOTIFY_OVERAVGDURATION_EXTERNAL_FILE_PATH_NAME_ATTACH,
                  triggerEmailExternalFileAttachName: ScheduledExecutionController.NOTIFY_OVERAVGDURATION_EXTERNAL_ATTACH,
                  isEmail: isAvg,
                  isUrl: isAvgUrl,
                  defEmail: defAvg,
                  defUrl: defAvgUrl,
...
<g:render template="/scheduledExecution/editNotificationsTriggerForm"
          model="${[
                  ...
                  triggerEmailExternalFilePathName: ScheduledExecutionController.NOTIFY_RETRYABLEFAILURE_EXTERNAL_FILE_PATH_NAME_ATTACH,
                  triggerEmailExternalFileAttachName: ScheduledExecutionController.NOTIFY_RETRYABLEFAILURE_EXTERNAL_ATTACH,
