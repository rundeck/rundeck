                      ...
                      <h3 class="card-title">
                        ...
                        <div class="pull-right">
                          <g:if test="${eprev || enext}">
                            <ul class="pager pager-embed pager-left pager-sm" style="margin:5px 0 0; font-size:12px;">
                              <g:if test="${eprev}">
                                <li>
                        ...
                        <div class="card-footer">
                              ...
                              <div class="btn-group">
                                  ...
                                  <g:if test="${auth.resourceAllowedTest(kind: 'job', action: [AuthConstants.ACTION_CREATE],project:execution.project)}">
                                      <g:link
                                              ...
                                              class=" btn btn-primary btn-xs header execRerun execRetry"
                                  ...
                                  <g:if test="${adhocRunAllowed && g.executionMode(active:true,project:execution.project)}">
                                      ...
                                      <g:link
                                              ...
                                              class="btn btn-default btn-xs force-last-child execRerun"
                          ...
                          <g:else>
                              ...
                              <div>
                                  ...
                                  <g:if test="${deleteExecAuth}">
                                      <div class="spacing" data-bind="visible: completed()">
                                          <a href="#execdelete" class="btn-xs btn btn-danger "
                                             data-toggle="modal">
                                              <b class="glyphicon glyphicon-remove-circle"></b>
                                              <g:message code="button.action.delete.this.execution" />
                                          </a>
