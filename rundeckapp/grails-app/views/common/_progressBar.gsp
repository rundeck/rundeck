...
<div id="${containerId}" class="progress" style="${height?'height: '+height+'px':''}">
    <div id="${progressId}" class="progress-bar ${overrun?'progress-striped active':''} ${progressType?:''}" role="progressbar" aria-valuenow="${completePercent}" aria-valuemin="0" aria-valuemax="100"
