...
<script type="text/javascript">
    ...
    var appLinks = {
        ...
        menuJobsAjax: "${g.createLink(controller: 'menu', action: 'jobsAjax',params:projParams + [format:'json'])}",
        menuJobSearchJson: '${createLink(controller:'menu',action:'jobsSearchJson',params: projParams)}',
