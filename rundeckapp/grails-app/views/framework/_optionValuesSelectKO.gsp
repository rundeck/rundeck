        ...
        <div data-bind="css: {'col-sm-4': hasTextfield(), 'col-sm-12': !hasTextfield() }">
            ...
            <div data-bind="if:!hasSingleEnforcedValue()">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-12 optionvaluemulti-add">
                                        <span class="btn btn-secondary btn-sm " data-bind="click: newMultivalueEntry">
                ...
                <div data-bind="if:!multivalued()">
                    ...
                    <div style="height: 55px; display: table-cell; width: 100%; vertical-align: bottom;">
...
<div data-bind="if: hasRemote() && remoteValues().length<1 && !remoteError()">
    <div class="row">
        <div class="col-sm-12">
            <div class="text-strong"><g:message code="option.remote.dependency.emptyresult"/></div>
        </div>
    </div>
</div>
