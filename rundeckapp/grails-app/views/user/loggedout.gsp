            ...
            <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">
                    <div class="logo">
                        <g:set var="logoImage" value="${processAutomation? 'static/img/pagerduty-full-logo.svg' : g.message(code: 'app.login.logo', default: '')?:'static/img/rundeck-combination.svg'}"/>
