...
<head>
    ...
    <asset:javascript src="trigger/show.js"/>
    ...
    <div class="col-sm-3">
        <section>
            <g:link
                ...
                <g:icon name="send"/>
                ${trigger.name ?: trigger.uuid}</g:link>
        ...
        <section class="section-space">
            <span class="text-muted">${trigger.uuid}</span>
        </section>
        <g:if test="${trigger.userData}">
            <section class="section-space">

                <g:basicData data="${trigger.userData}" fields="${trigger.userData?.keySet()?.sort()}"/>
            </section>
        </g:if>
    </div>
        ...
        <div class="list-group">
            <div class="list-group-item">
                ...
                <g:render template="/framework/renderPluginConfig"
                          model="${[serviceName           : 'TriggerCondition', values: trigger.conditionConfig, description: conditionPlugins
                          [
                                  trigger.conditionType
                                  ].description, hideTitle: false]}"/>
            ...
            <div class="list-group-item">
                ...
                <g:render template="/framework/renderPluginConfig"
                          model="${[serviceName           : 'TriggerAction', values: trigger.actionConfig, description: actionPlugins
                          [
                                  trigger.actionType
                                  ].description, hideTitle: false]}"/>
            </div>
    ...
    <div class="col-sm-12">
        <g:if test="${trigger.events}">
            <table class="table table-bordered table-condensed">
                ...
                <g:each in="${trigger.events.sort { a, b -> b.dateCreated <=> a.dateCreated }}" var="event">
