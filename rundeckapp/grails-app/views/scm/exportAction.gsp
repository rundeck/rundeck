                                    ...
                                    <div class="checkbox col-sm-12">
                                        <label>
                                            ...
                                            <g:render template="statusIcon"
                                                      model="[iscommit: true, status: jobstatus?.synchState?.toString(), notext: true, text: '', commit: jobstatus?.commit]"/>
                                            <g:render template="statusIcon"
                                                      model="[iscommit: true, status: jobstatus?.synchState?.toString(), noicon: true, text: job.jobName, commit: jobstatus?.commit]"/>
