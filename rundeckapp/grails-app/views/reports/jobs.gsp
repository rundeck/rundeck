<html>
    ...
    <meta name="layout" content="base"/>
        <meta name="tabpage" content="jobReports"/>
        <meta name="selectedMenu" content="Events"/>
        <meta name="rssfeed" content="${createLink(controller:"feed",action:"jobs",params:paginateParams)}"/>
                ...
                <div class="presentation filter">
                    ...
                    <table class="simpleForm">
                        ...
                        <div class="presentation">
                            ...
                            <div>
                                <g:actionSubmit value="Commands" action="Commands"/>
                            </div>
                            <div>
            ...
            <td style="text-align:left;vertical-align:top;">
                <div>
                    <g:if test="${displayParams}">
                        <span class="prompt">${total} Completed <g:message code="domain.ScheduledExecution.title"/><g:if test="${total!=1}">s</g:if></span>
                        matching filter
