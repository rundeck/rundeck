                                          ...
                                          <g:if test="${dataset[dataname] instanceof Map}">
                                              <div class="card">
                                                <div class="card-header">
                                                  <h4 class="card-title"><g:enc>${dataname}</g:enc></h4>
                                                </div>
                                              ...
                                              <g:each
                                                      ...
                                                      var="valuename">
                                                  <div>
                                                      <div title="${enc(attr:dataset[dataname][valuename + '.info'] ?: '')}"><g:enc>${valuename}</g:enc></div>
                                                      <div class="${valuename=='serverUUID'?'rundeck-server-uuid':''} ${dataset[dataname][valuename+'.status']?'text-'+dataset[dataname][valuename+'.status']:''}" data-server-uuid="${ valuename=='serverUUID'? dataset[dataname][valuename]:''}">
