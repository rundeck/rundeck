...
<head>
    ...
    <meta name="tabtitle" content="${g.message(code: 'gui.menu.Admin')}"/>
                            ...
                            <g:each var="config" in="${configs}" status="n">
                                <li>
                                    <div class="inpageconfig">
                                        <g:set var="desc"
                                               value="${resourceModelConfigDescriptions.find {
                                                   it.name == config.type
                                               }}"/>
                                        <g:if test="${desc}">
                                        ...
                                        <g:else>
                                            <span
                                                    class="text-warning"><g:message
                                                    code="invalid.resource.model.source.configuration.provider.not.found"
                                                    args="${[config.type]}"/></span>
                                        </g:else>
                ...
                <g:each in="${categories.sort()}" var="category">
                    ...
                    <g:render template="projectConfigurableView"
                              model="${[extraConfigSet: extraConfig?.values(),
                                        ...
                                        helpCode      : 'project.configuration.extra.category.' + category +
                                                '.description'
                              ]}"/>
