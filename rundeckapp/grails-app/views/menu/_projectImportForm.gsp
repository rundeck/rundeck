      ...
      <div class="card" id="importform">
        ...
        <div class="card-footer">
          <div id="uploadFormButtons">
            ...
            <g:actionSubmit action="importArchive" value="Import" id="uploadFormUpload" onclick="['uploadFormButtons','importUploadSpinner'].each(Element.toggle)" class="btn btn-primary"/>
          </div>
