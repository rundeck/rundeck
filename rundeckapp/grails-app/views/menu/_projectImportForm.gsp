    ...
    <div class="card" id="importform">
      ...
      <div class="card-footer">
        <div id="uploadFormButtons">
          ...
          <g:actionSubmit action="importArchive" value="${g.message(code:'button.action.Import',default:'Import')}" id="uploadFormUpload" class="btn btn-cta btn-sm"/>
          <script nonce="${security.cspNonce()}" type="text/javascript">
          document.getElementById('uploadFormUpload').addEventListener('click', function(event) {
            ['uploadFormButtons','importUploadSpinner'].each(Element.toggle)
          });
          </script>
        </div>
