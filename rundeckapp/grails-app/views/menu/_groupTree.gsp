        ...
        <g:else>
            ...
            <g:if test="${!jobsjscallback}">
                ...
                <span class="" data-bind="visible: enabled">
                    &bull;
                    <a href="#" class="btn btn-sm btn-simple btn-hover" data-job-group="${group.key}" data-bind="click: function(){jobGroupSelectAll($element);}">
                        <g:icon name="check"/>
                        <g:message code="select.all" />
                    </a>
                    <a href="#" class="btn btn-sm btn-simple btn-hover" data-job-group="${group.key}" data-bind="click: function(){jobGroupSelectNone($element);}">
