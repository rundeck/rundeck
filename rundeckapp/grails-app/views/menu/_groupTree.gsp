...
<g:each in="${gkeys}" var="group">
    ...
    <div class="expandComponentHolder" style="${indent>0? 'margin-left: '+(indent*indentpx)+'px;':''}">
        ...
        <g:if test="${jobgroups[group.key]}">
            <div class="jobGroups subdirs expandComponent" style="margin-left: ${((indent+1)*indentpx)}px; ${wdgt.styleVisible(unless:group.value?.size()>0 && !(wasfiltered) )}" >
