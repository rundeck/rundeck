...
@OpenAPIDefinition(
    ...
    tags = [
        ...
        @Tag(name = "Adhoc", description = "Ad-hoc command execution operations"),
        ...
        @Tag(name = "Bulk", description = "Bulk operations"),
