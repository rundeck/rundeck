...
databaseChangeLog = {
    ...
    changeSet(author: "rundeckuser (generated)", id: "4.11.0-wizard-id-e4e421", dbms: "postgres") {
    ...
    changeSet(author: "rundeckuser (generated)", id: "4.11.0-wizard-id-e4e421-D", dbms: "h2") {
        comment { 'Add id to node-wizard node source configuration' }
        preConditions(onFail: "MARK_RAN"){
            and{
                tableExists (tableName:"storage")
