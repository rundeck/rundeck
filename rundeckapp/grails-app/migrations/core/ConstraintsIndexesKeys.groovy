...
databaseChangeLog = {
    ...
    changeSet(author: "rundeckuser (generated)", id: "3.4.0-29", failOnError:"false", dbms:"mysql,postgresql,mariadb") {
        preConditions(onFail: "MARK_RAN"){
            not{
                if(!'${constraintSchema}'.isEmpty()){
                    uniqueConstraintExists (catalogName: '${constraintSchema}', tableName:"auth_token", constraintName:"UC_AUTH_TOKENTOKEN_COL")
                }else{
    ...
    changeSet(author: "rundeckuser (generated)", id: "3.4.0-30", failOnError:"false", dbms:"mysql,postgresql,mariadb") {
        preConditions(onFail: "MARK_RAN"){
            not{
                if(!'${constraintSchema}'.isEmpty()){
                    uniqueConstraintExists (catalogName: '${constraintSchema}', tableName:"log_file_storage_request", constraintName:"UC_LOG_FILE_STORAGE_REQUESTEXECUTION_ID_COL")
                }else{
                    uniqueConstraintExists (tableName:"log_file_storage_request", constraintName:"UC_LOG_FILE_STORAGE_REQUESTEXECUTION_ID_COL")
                }
            }
        }
    ...
    changeSet(author: "rundeckuser (generated)", id: "3.4.0-31", failOnError:"false", dbms:"mysql,postgresql,mariadb") {
        preConditions(onFail: "MARK_RAN"){
            not{
                if(!'${constraintSchema}'.isEmpty()){
                    uniqueConstraintExists (catalogName: '${constraintSchema}', tableName:"project", constraintName:"UC_PROJECTNAME_COL")
                }else{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    changeSet(author: "rundeckuser (generated)", failOnError:"false", id: "3.4.0-32", dbms:"mysql,postgresql,mariadb,oracle,h2") {
        preConditions(onFail: "MARK_RAN"){
            not{
                if(!'${constraintSchema}'.isEmpty()){
                    uniqueConstraintExists (catalogName: '${constraintSchema}', tableName:"report_filter", constraintName:"UC_REPORT_FILTERNAME_COL")
                }else{
                    uniqueConstraintExists (tableName:"report_filter", constraintName:"UC_REPORT_FILTERNAME_COL")
                }
            }
        }
    ...
    changeSet(author: "rundeckuser (generated)", failOnError:"false", id: "3.4.0-33", dbms:"mysql,postgresql,mariadb,oracle,h2") {
        preConditions(onFail: "MARK_RAN"){
            not{
                if(!'${constraintSchema}'.isEmpty()){
                    uniqueConstraintExists (catalogName: '${constraintSchema}', tableName:"scheduled_execution", constraintName:"UC_SCHEDULED_EXECUTIONUUID_COL")
                }else{
                    uniqueConstraintExists (tableName:"scheduled_execution", constraintName:"UC_SCHEDULED_EXECUTIONUUID_COL")
                }
            }
        }
    ...
    changeSet(author: "rundeckuser (generated)", failOnError:"false", id: "3.4.0-34", dbms:"mysql,postgresql,mariadb,oracle,h2") {
        preConditions(onFail: "MARK_RAN"){
            not{
                if(!'${constraintSchema}'.isEmpty()){
                    uniqueConstraintExists (catalogName: '${constraintSchema}', tableName:"storage", constraintName:"UC_STORAGEPATH_SHA_COL")
                }else{
                    uniqueConstraintExists (tableName:"storage", constraintName:"UC_STORAGEPATH_SHA_COL")
                }
            }
        }
