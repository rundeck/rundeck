...
//        "/project/$project/exportDownload"(controller: 'project',action: 'export')
        ...
        "/menu/fileStorage/$resourcePath**"(controller: 'menu', action: 'fileStorage')
        ...
        "/storage/access/files/$resourcePath**"(controller: 'storage', action: 'fileStorageAccess')
        "/storage/access/files"(controller: 'storage', action: 'fileStorageAccess')
        ...
        "/storage/delete/files"(controller: 'storage', action: 'fileStorageDelete')
        ...
        "/storage/download/files"(controller: 'storage', action: 'fileStorageDownload')
        "/storage/download/files/$resourcePath**"(controller: 'storage', action: 'filesStorageDownload')
