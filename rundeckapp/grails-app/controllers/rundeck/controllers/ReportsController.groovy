...
class ReportsController extends ControllerBase{
    ...
    public def index_old (ExecQuery query) {
        ...
        if(unauthorizedResponse(rundeckAuthContextEvaluator.authorizeProjectResourceAll(authContext, AuthorizationUtil
...
//                params.saveFilter = true
    ...
    def apiHistory(ExecQuery query){
        ...
        AuthContext authContext = rundeckAuthContextProvider.getAuthContextForSubjectAndProject(session.subject,params.project)
        if (!rundeckAuthContextEvaluator.authorizeProjectResourceAll(authContext, AuthConstants.RESOURCE_TYPE_EVENT,
