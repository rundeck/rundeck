...
class TaskRep implements EmbeddedJsonData {
    long id
    String project
    String name
    String description
    ...
    public Map getTriggerConfig() {
        return asJsonMap(triggerData)
    }

    public void setTriggerConfig(Map obj) {
        triggerData = serializeJsonMap(obj)
    }

    public Map getUserData() {
        return asJsonMap(taskUserData)
    }
