...
function BulkEditor(){
    ...
    self.jobText = function(jobid){
        ...
        if(self.scmStatus() && self.scmStatus()[jobid]){
            ...
            switch(exportStatus) {
                case "EXPORT_NEEDED":
                    text = message("scm.export.status.EXPORT_NEEDED.description");
                    break;
                case "CREATE_NEEDED":
                    text = message("scm.export.status.CREATE_NEEDED.description");
                    break;
                case "CLEAN":
                    text = message("scm.export.status.CLEAN.description");
                    break;
                default:
                    text = exportStatus;
            }
        ...
        if(self.scmImportJobStatus() && self.scmImportJobStatus()[jobid]){
            ...
            switch(importStatus) {
                case "IMPORT_NEEDED":
                    text += message("scm.import.status.IMPORT_NEEDED.description");
                    break;
                case "DELETE_NEEDED":
                    text += message("scm.import.status.DELETE_NEEDED.description");
                    break;
                case "CLEAN":
                    text += message("scm.import.status.CLEAN.description");
                    break;
                case "REFRESH_NEEDED":
                    text += message("scm.import.status.REFRESH_NEEDED.description");
                    break;
                case "UNKNOWN":
                    text += message("scm.import.status.UNKNOWN.description");
                    break;
                default:
                    text += importStatus;
            }
    ...
    self.defaultExportText = function(){
        if(self.exportState()) {
            ...
            switch(self.exportState()) {
                case "EXPORT_NEEDED":
                    text = message("scm.export.status.EXPORT_NEEDED.display.text");
                    break;
                case "CREATE_NEEDED":
                    text = message("scm.export.status.CREATE_NEEDED.display.text");
                    break;
                case "REFRESH_NEEDED":
                    text = message("scm.export.status.REFRESH_NEEDED.display.text");
                    break;
                case "DELETED":
                    text = message("scm.export.status.DELETED.display.text");
                    break;
                case "CLEAN":
                    text = message("scm.export.status.CLEAN.display.text");
                    break;
            }
            if(!text){
    ...
    self.defaultImportText = function(){
        if(self.importState()) {
            ...
            switch(self.importState()) {
                case "IMPORT_NEEDED":
                    text = message("scm.import.status.IMPORT_NEEDED.display.text");
                    break;
                case "REFRESH_NEEDED":
                    text = message("scm.import.status.REFRESH_NEEDED.display.text");
                    break;
                case "UNKNOWN":
                    text = message("scm.import.status.UNKNOWN.display.text");
                    break;
                case "CLEAN":
                    text = message("scm.import.status.CLEAN.display.text");
                    break;
            }
            if(!text){
