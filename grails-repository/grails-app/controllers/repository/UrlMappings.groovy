...
class UrlMappings {
    ...
    static mappings = {
        ...
        if(getGrailsApplication().config.getProperty("rundeck.feature.repository.enabled",String.class) in ["true",true]) {
            ...
            //         action: "uninstallArtifact"
            // )
            post "/repository/uninstall/$artifactId/$service?/$name?"(
                    controller: "repository",
                    action: "uninstallArtifact"
            )
        }
