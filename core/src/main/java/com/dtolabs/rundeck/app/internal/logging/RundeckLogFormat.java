...
public class RundeckLogFormat implements OutputLogFormat, LineLogFormat {
    ...
    public static class RDFormatItem implements FormatItem {
        boolean fileEnd;
        ...
        public static FormatItem error(String message) {
     ...
     * @param line
     */
    public FormatItem parseLine(String line) {
...
//        return unescape(input, escapeChar, validEscaped, delimiter);
//    }
    /**
     * unescape a string, returning the result, whether the delimiter was seen, and any remaining string
     * @param input input stream
     ...
     * @return List of: String unescaped, String delimiterReached, String remaining
     */
