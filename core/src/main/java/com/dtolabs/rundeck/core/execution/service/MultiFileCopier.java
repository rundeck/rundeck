 ...
 * @since 3/30/17
 */
public interface MultiFileCopier {
    /**
     ...
     */
    String[] copyFiles(ExecutionContext context, List<File> files, String remotePath, INodeEntry node) throws FileCopierException;
}
