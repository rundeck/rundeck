...
class RundeckLogFormatTest  {
    ...
    void assertDecode(String expect, String expectDone, String input) {
        ...
        def testString = unescapedData.unescaped
        def testDone = unescapedData.delimiterReached
    ...
    void assertUnescape(String expect, String expectDone, String expectRest,
        ...
        def testString = unescapedData.unescaped
        def testDone = unescapedData.delimiterReached
        def rest = unescapedData.remaining
    ...
    @Test void testUnescapeEmptyLogLine() {
        ...
        def text = unescapedData.unescaped
        def done = unescapedData.delimiterReached
        def rest = unescapedData.remaining
