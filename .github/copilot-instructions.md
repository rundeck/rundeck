...
**When writing or reviewing tests, verify they meet these must-do criteria:**
- 0 occurrences of `Thread.sleep` or `.hold` in tests added/edited
- 0 CSS selectors in test spec files (use Page Objects)
- Cleanup blocks present in all tests
- Reusing existing BasePage methods instead of creating duplicate functionality
- Resources have unique names (UUID-based)
