...
class LogViewerOutput extends SeleniumBase{
    ...
    def "auto scroll on log viewer page show last input"() {
        ...
        jobCreatePage.waitForStepToBeShown(By.name("pluginConfig.adhocRemoteStringField"))
        jobCreatePage.el(By.name("pluginConfig.adhocRemoteStringField")).sendKeys("for i in {1..60}; do echo NUMBER \$i; sleep 0.2; done")
