...
class JobCreatePage extends BasePage {
    ...
    By cancelNewStepFormBy = By.cssSelector('ol.flowlist li span.btn.btn-default.btn-sm[id^="wfiCancelNewBtn_"]')
    By cancelEditStepFormBy = By.cssSelector('ol.flowlist li span.btn.btn-default.btn-sm[id^="wfiViewCancelBtn_"]')
