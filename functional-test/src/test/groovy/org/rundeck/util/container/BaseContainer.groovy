...
abstract class BaseContainer extends Specification implements ClientProvider {
    ...
    void setupProject(String name, String projectImportLocation) {
        ...
        if (getProject.code() == 404) {
            ...
            client.doPut("/project/${name}/import?importConfig=true&importACL=true&importNodesSources=true&importScm=true", new File(getClass().getResource(projectImportLocation).getPath()))
